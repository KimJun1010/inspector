 ...
 */
package com.itkim.inspector.rule.xxe;
 ...
 */
public class XXEInspector extends BaseLocalInspectionTool {
    ...
    public @NotNull PsiElementVisitor buildVisitor(@NotNull ProblemsHolder holder, boolean isOnTheFly) {
        return new JavaElementVisitor() {
            ...
            public void visitMethodCallExpression(PsiMethodCallExpression expression) {
                if (SecExpressionUtils.hasFullQualifiedName(expression, "javax.xml.parsers.DocumentBuilderFactory", "newInstance")) {
                    commonExpressionCheck(expression, "setFeature", XmlFactory.DOCUMENT_BUILDER_FACTORY, false);
                } else if (SecExpressionUtils.hasFullQualifiedName(expression, "javax.xml.parsers.SAXParserFactory", "newInstance")) {
                    commonExpressionCheck(expression, "setFeature", XmlFactory.SAX_PARSER_FACTORY, false);
                } else if (SecExpressionUtils.hasFullQualifiedName(expression, "javax.xml.transform.sax.SAXTransformerFactory", "newInstance")) {
                    commonExpressionCheck(expression, "setAttribute", XmlFactory.SAX_TRANSFORMER_FACTORY, true);
                } else if (SecExpressionUtils.hasFullQualifiedName(expression, "org.xml.sax.helpers.XMLReaderFactory", "createXMLReader")) {
                    commonExpressionCheck(expression, "setFeature", XmlFactory.XML_READER_FACTORY, false);
                } else if (SecExpressionUtils.hasFullQualifiedName(expression, "javax.xml.validation.SchemaFactory", "newInstance")) {
                    commonExpressionCheck(expression, "setProperty", XmlFactory.SCHEMA_FACTORY, false);
                } else if (SecExpressionUtils.hasFullQualifiedName(expression, "javax.xml.stream.XMLInputFactory", "newFactory")) {
                    commonExpressionCheck(expression, "setProperty", XmlFactory.XML_INPUT_FACTORY, false);
                } else if (SecExpressionUtils.hasFullQualifiedName(expression, "javax.xml.transform.TransformerFactory", "newInstance")) {
                    commonExpressionCheck(expression, "setAttribute", XmlFactory.TRANSFORMER_FACTORY, true);
                } else if (SecExpressionUtils.hasFullQualifiedName(expression, "javax.xml.validation.Schema", "newValidator")) {
                    commonExpressionCheck(expression, "setProperty", XmlFactory.VALIDATOR_OF_SCHEMA, false);
                } else if (SecExpressionUtils.hasFullQualifiedName(expression, "org.apache.commons.digester3.Digester", "parse")) {
            ...
            public void visitNewExpression(PsiNewExpression expression) {
                if (SecExpressionUtils.hasFullQualifiedName(expression, "org.jdom.input.SAXBuilder")) {
                    commonExpressionCheck(expression, "setFeature", XmlFactory.SAX_BUILDER, false);
                } else if (SecExpressionUtils.hasFullQualifiedName(expression, "org.dom4j.io.SAXReader")) {
    ...
    private static class DisableEntityElementVisitor extends BaseFixElementWalkingVisitor {
