 ...
 */
public class NettyResponseSplitting extends BaseLocalInspectionTool {
    ...
    public @NotNull PsiElementVisitor buildVisitor(@NotNull ProblemsHolder holder, boolean isOnTheFly) {
        return new JavaElementVisitor() {
            ...
            public void visitNewExpression(PsiNewExpression expression) {
                if (SecExpressionUtils.hasFullQualifiedName(expression, "io.netty.handler.codec.http.DefaultHttpHeaders")) {
                ...
                if (SecExpressionUtils.hasFullQualifiedName(expression, "io.netty.handler.codec.http.DefaultHttpResponse")) {
                    if (expression.getArgumentList() != null) {
                        PsiExpression[] args = expression.getArgumentList().getExpressions();
