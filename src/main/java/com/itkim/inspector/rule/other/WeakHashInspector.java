 ...
 */
public class WeakHashInspector extends BaseLocalInspectionTool {
    ...
    public @NotNull PsiElementVisitor buildVisitor(@NotNull ProblemsHolder holder, boolean isOnTheFly) {
        return new JavaElementVisitor() {
            ...
            public void visitNewExpression(PsiNewExpression expression) {
                if (SecExpressionUtils.hasFullQualifiedName(expression, "org.apache.commons.codec.digest.DigestUtils")) {
                    checkZeroArgs(expression);
                }
            }
            ...
            private void checkZeroArgs(PsiCallExpression expression) {
                ...
                if (args.length > 0 && args[0] instanceof PsiLiteralExpression) {
                    String mdName = SecExpressionUtils.getLiteralInnerText(args[0]);
